...
export const metadata: Metadata = {
  title: "認識TAIDE - 推動台灣可信任生成式AI發展計畫",
  description:
    "深入了解TAIDE計畫的背後故事。探討其起源，並見證台灣AI技術如何藉此邁向新的高峰。",
  openGraph: {
    description:
      "深入了解TAIDE計畫的背後故事。探討其起源，並見證台灣AI技術如何藉此邁向新的高峰。",
  },
...
const AboutProject = async () => {
  const jsonLd: WithContext<any> = {
    ...
    "@type": "Organization",
    name: "深入了解TAIDE計畫的背後故事。探討其起源，並見證台灣AI技術如何藉此邁向新的高峰。",
    additionalName:
      "深入了解TAIDE計畫的背後故事。探討其起源，並見證台灣AI技術如何藉此邁向新的高峰。",
      ...
      <article className="aboutUnit project">
        <div className="aboutUnit__body">
          ...
          <div className="section section3">
            <h2>
              <span>確保AI技術</span>
              <span>對台灣和全球的正面影響</span>
            </h2>
            <div className="text">
              建立可信任的生成式AI對話引擎基礎模型是當前的重要任務，需要考慮本土化需求並確保訓練資料的品質和適用性。此外，全球各國也紛紛制定相關規範和準則，以確保AI技術的可信任性和安全性。臺灣應加強在生成式AI技術和應用方面的投入，提高臺灣的科技實力和競爭力，並確保AI技術對台灣和全球的正面影響。
            </div>
            <ol>
              <li>
                <h3>
                ...
                <p>
                  培育台灣自有人才與技術，孕育下個世代的競爭力，也不用依賴外國技術，更能保障台灣安全。
                </p>
              ...
              <li>
                ...
                <p>
                  發展自有AI技術能夠促進台灣相關產業的發展，並有助完善整個AI產業鏈。
                </p>
                <div className="tagList2">
                  <div className="tagUnit about1">生成式AI人才扎根</div>
